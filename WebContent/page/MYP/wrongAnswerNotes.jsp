...
<head>
    ...
    <link rel="stylesheet" href="../../css/pc960/MYP/wrongAnswerNotes.css">
    ...
    <div id="haru_contents_wrap">
        ...
        <section id="haru_subcontents">
            <header id="haru_subheader" class="haru_pc">
                <div id="haru_subtitle">오답노트</div>
                <div id="haru_cat">
                    <p>HOME > My 페이지 > 오답노트</p>
                </div>
            </header>                    
            <!-- SubContents Here -->
            <div id="wrongNotes" ondrop="drop(event)" ondragover="allowDrop(event)">
            <!-- <div id="wrongNotes"> -->
            </div>
            <!-- //SubContents Here -->
        </section>
