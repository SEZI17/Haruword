            ...
            <div class="container">
                ...
                <div class="search">
                    ...
                    <div class="category">
                        ...
                        <a href="#" class="catselect">카테고리 선택</a>
                        <a href="#" class="cate">TIP</a>
                        <a href="#" class="cate">합격수기</a>
                    </div>
                    <!-- //카테고리 -->
                    <form @prevent.action="submit">
                ...
                <div class="board_section">
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td><a href="./tip-example.jsp?id=1">3</a></td>
                                <td class="board_article"><a href="./tip-example.jsp?id=1">안녕하세요</a></td>
                                <td><a href="./tip-example.jsp?id=1">장세진</a></td>
                                <td><a href="./tip-example.jsp?id=1">16</a></td>
                                <td><a href="./tip-example.jsp?id=1">2019-09-03</a></td>
                            </tr>
                            <tr>
                                <td><a href="./tip-example.jsp?id=2">2</a></td>
                                <td class="board_article"><a href="./tip-example.jsp?id=2">처음 뵙겠습니다.</a></td>
                                <td><a href="./tip-example.jsp?id=2">천세문</a></td>
                                <td><a href="./tip-example.jsp?id=2">16</a></td>
                                <td><a href="./tip-example.jsp?id=2">2019-09-03</a></td>
                            </tr>
                            <tr>
                                <td><a href="./tip-example.jsp?id=3">1</a></td>
                                <td class="board_article"><a href="./tip-example.jsp?id=3">단어 잘 외우는 법</a></td>
                                <td><a href="./tip-example.jsp?id=3">윤의태</a></td>
                                <td><a href="./tip-example.jsp?id=3">16</a></td>
                                <td><a href="./tip-example.jsp?id=3">2019-09-03</a></td>
                            </tr>
                        </tbody>
                        <!-- //게시판 글 -->
                    </table>
